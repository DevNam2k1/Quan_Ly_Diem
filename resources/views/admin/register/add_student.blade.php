...
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Thêm Tài Khoản Sinh Viên</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<div class="card">
  ...
  @endif
      ...
      <form action="{{URL::to('register-student-id')}}" method="post">
        {{ csrf_field() }}
        
          <select id="student_id" class="form-control select2 choose2 student-id" style="width: 100%" name="student_id">
            <option selected="selected">--Chọn Mã Sinh Viên--</option>
            @foreach ($student_list as $item => $student)
        ...
        @endif
          ...
          <select id="student_name" class="form-control select2  student-name" style="width: 100%" name="student_name">
